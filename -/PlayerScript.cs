...
public class PlayerScript : MonoBehaviour
{
	...
	private void MouseMove()
	{
		...
		this.playerRotation.eulerAngles = this.playerRotation.eulerAngles + Vector3.up * this.player.GetAxis("Turn") * this.mouseSensitivity * Time.timeScale * this.flipaturn;
	...
	private void PlayerMove()
	{
		...
		vector = base.transform.forward * this.player.GetAxis("Forward");
		vector2 = base.transform.right * this.player.GetAxis("Strafe");
		if (this.stamina > 0f)
		{
	...
	private void StaminaCheck()
	{
		...
		{
			if (this.player.GetButton("Run") & this.stamina > 0f)
			{
